...
class Snipe(commands.Cog):
    ...
    async def snipe_deleted_message(self, ctx: Context, index: int = 0):
        ...
        if index < 0:
            warning_message = "Snipe number must be a positive integer."
    ...
    async def snipe_edited_message(self, ctx: Context, index=0):
        ...
        try:
            ...
            logger.error(f"An error occurred in Snipe snipe_edited_message: {e}")
    ...
    async def snipe_reaction(self, ctx: Context):
        ...
        try:
            ...
            logger.error(f"An error occurred in Snipe snipe_reaction: {e}")
...
async def setup(bot: Sparky):
    try:
        ...
        logger.error(f"ERROR: Failed to setup Snipe: {e}")
